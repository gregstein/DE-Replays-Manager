...
namespace DepotDownloader
{
    ...
    class Steam3Session
    {
        ...
        public List<uint> prevIDS = new List<uint>();
        ...
        public Steam3Session( SteamUser.LogOnDetails details )
        {
            ...
            Console.Write(System.Reflection.Assembly.GetExecutingAssembly().Location + "Connecting to Steam3..." );
        ...
        public void ShowDepotKey(uint depotId, uint appid = 0)
        {
